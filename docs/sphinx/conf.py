...
htmlhelp_basename = 'python_templatepdoc'
...
latex_documents = [
    (master_doc, 'python_template.tex', u'python_template Documentation',
     u'Your name', 'manual'),
]
...
man_pages = [
    (master_doc, 'python_template', u'python_template Documentation',
     [author], 1)
]
